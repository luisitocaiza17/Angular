...
@Component({
    ...
    templateUrl: 'devSaldosContrato.list.template.html'
})

export class DevSaldosFavorContratoListComponent implements OnInit {
    ...
    inicializarPanelSobres(selected: ContratoEntityList): void {
        ...
        jQuery("#divPanelDevolucionSaldos").collapse("show");
        ...
        // scroll top
        this.chRef.detectChanges();
        var inipos = jQuery("#divPanelDevolucionSaldos").position().top;
