...
@Component({
    ...
    templateUrl: 'facturarCobrosPichincha.component.html', 
    styleUrls: ['facturarCobrosPichincha.component.css']
})

export class FacturarCobrosPichinchaComponent implements OnInit{
