...
@Component({
    selector: 'encabezadoLiquidacionForm',
    providers: [BeneficiarioService],
    templateUrl: 'encabezadoLiquidacion.form.template.html'
})

export class EncabezadoLiquidacionFormComponent {
            ...
            if (beneficiarioFilter != null) {
                this.beneficiarioService.getBeneficiarioAutorizacion(beneficiarioFilter).subscribe(
                    beneficiarios => {
                        ...
                        this.onChangeSelection(this._autorizacion.PersonaNumero);
                    },
