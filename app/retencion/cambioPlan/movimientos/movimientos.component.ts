...
import { RetencionCambioPlanComponent } from '../retencion.cambio.plan.component';
...
export class MovimientosComponent extends TabPanelControl implements OnDestroy {
    ...
    constructor(public movimientoService: MovimientoService, private route: ActivatedRoute,
        ...
        private retencionCambioPlanComponent: RetencionCambioPlanComponent,
        ...
        this.suscription = this.retencionCambioPlanComponent.selectContrato$.subscribe(
            (contratoKey) => {
