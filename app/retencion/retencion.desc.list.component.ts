...
@Component({
    templateUrl: 'retencion.desc.list.template.html'
})

export class DescuentoRetencionListComponent {
    ...
    constructor(
        ...
        this.activatedRoute.queryParams.subscribe(params => {
            ...
            this
                .retencionService
                .filtrarContratos(this.filtro, this.itemsPerPage, this.currentPage)
                .subscribe(res => {
    ...
    enviar(): void {
        ...
        this.router.navigate(['/retencion/descuento/list'], { queryParams: this.queryParams() });
    }
    ...
    crearContratoKey(selected: ContratoEntityList): void {
        console.log('entro en create contrato list component desc');
        ...
        this.router.navigate(['/retencion/descuento/show', selected.CodigoRegion, selected.CodigoProducto, selected.NumeroContrato]);
    }
